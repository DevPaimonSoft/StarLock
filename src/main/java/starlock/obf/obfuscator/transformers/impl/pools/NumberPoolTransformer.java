...
public class NumberPoolTransformer extends PoolTransformer {
    ...
    public void obfuscate(ClassNode classNode){
        ...
        FieldNode field = new FieldNode(ACC_PRIVATE|ACC_STATIC|ACC_SYNTHETIC, NumberPoolTransformer.getRandomString(new Random().nextInt(256),1),"Ljava/lang/String;",null, null);
        FieldNode fieldPool = new FieldNode(ACC_PRIVATE|ACC_STATIC|ACC_SYNTHETIC, NumberPoolTransformer.getRandomString(new Random().nextInt(256),1),"[Ljava/lang/String;",null, null);
        ...
        if(cpool.get()){
            ...
            if(poolKey.isEmpty())
                poolKey = NumberPoolTransformer.getUnicodeString(126);
