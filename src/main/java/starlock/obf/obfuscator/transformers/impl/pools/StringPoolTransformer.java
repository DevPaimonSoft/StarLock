...
public class StringPoolTransformer extends PoolTransformer {
    ...
    public void obfuscate(ClassNode classNode){
        ...
        FieldNode field = new FieldNode(ACC_PRIVATE|ACC_STATIC|ACC_SYNTHETIC, StringPoolTransformer.getRandomString(new Random().nextInt(256),1),"Ljava/lang/String;",null, null);
        FieldNode fieldPool = new FieldNode(ACC_PRIVATE|ACC_STATIC|ACC_SYNTHETIC, StringPoolTransformer.getRandomString(new Random().nextInt(256),1),"[Ljava/lang/String;",null, null);
